...
namespace PR.WizPlant.Integrate.WcfHost
{
    ...
    /// </summary>
    public class ScadaService : IHttpHandler
    {
        public ILog logger = LogManager.GetLogger<ScadaService>();
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (methodName)
            {
                ...
                case "001":                   
                    ...
                    result = ScadaHelper.GetObjectTags(param);
                    break;
                // GetTagModelValue
                case "002":
                    // 测点集   
                    ...
                    result = ScadaHelper.GetTagModelValue(int.Parse(date), tags, Convert.ToBoolean(int.Parse(isShowDetail)));
                    break;
                // GetTagDetailValue
                case "003":
                    // 测点集   
                    ...
                    result = ScadaHelper.GetTagDetailValue(int.Parse(date), tags, Convert.ToBoolean(int.Parse(onlyLast)));
                    break;
                // GetTagListValue
                case "004":
                    // 测点集   
                    ...
                    result = ScadaHelper.GetTagListValue(int.Parse(date), tags);
                    break;
            }
